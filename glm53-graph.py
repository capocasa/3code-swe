#!/usr/bin/env python3
"""16:9 GLM-5.3 SWE-bench poster. Numeric meme for X mobile."""
...
OUT = ROOT / "glm53-benchmark.png"
OUT_OG = ROOT / "glm53-benchmark-og.png"
...
AGENTS = ["3code", "pi", "zcode", "hermes", "opencode"]
TOKENS = {
    "3code": 4_209_360,
    "pi": 4_641_357,
    "zcode": 4_766_000,
...
RESOLVED = {a: 7 if a == "3code" else 6 for a in AGENTS}
LEADER = TOKENS["3code"]
TOKEN_MAX = 7_200_000
W, H = 16.0, 9.0
...
def main() -> None:
    ...
    txt(
        ax, 0.70, 8.48,
        "5 agents  ·  10 SWE-bench tasks  ·  1 model (GLM-5.3)",
    ...
    txt(ax, pct_x, hdr_y, "vs 3code", SANS_MD, 26, MUTED, ha="right")
